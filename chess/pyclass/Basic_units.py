...
class Knight(Piece):
    def __init__(self, x: int, y: int, color: str, board) -> Piece:
        super().__init__(x, y, color, board, "N")
...
class Bishop(Piece):
    def __init__(self, x: int, y: int, color: str, board) -> Piece:
        super().__init__(x, y, color, board, "B")
...
class Queen(Piece):
    def __init__(self, x: int, y: int, color: str, board) -> Piece:
        super().__init__(x, y, color, board, "Q")
...
class Rook(Piece):
    def __init__(self, x: int, y: int, color: str, board) -> Piece:
        super().__init__(x, y, color, board, "R")
        self.added_moves.append(Rook_Move)
        self.added_attacks.append(Rook_Attack)
